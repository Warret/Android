package com.example.myguessstar;
...
public class MainActivity extends AppCompatActivity {
    ...
    private String url = "https://intrigue.dating/samoe-pikantnoe/samye-krasivye-pornoaktrisy-top-30/";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button0 = findViewById(R.id.variant0);
        button1 = findViewById(R.id.variant1);
        button2 = findViewById(R.id.variant2);
        button3 = findViewById(R.id.variant3);
    ...
    private void getContent() {
        ...
        try {
            ...
            String start = "<ul><li>Мия Халифа</li></ul>";
            String finish = "<div id=\"zuzu_viral_reactions\">";
...
//            Log.i("MyName", splitContent);
            Pattern patternImg = Pattern.compile("<img itemprop=\"image\" src=\"(.*?)\"");
